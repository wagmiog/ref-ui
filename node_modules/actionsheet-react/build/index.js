...
var ActionSheet = React__namespace.forwardRef(function (_a, ref) {
    var onClose = _a.onClose, children = _a.children, sheetStyle = _a.sheetStyle, bgStyle = _a.bgStyle, _b = _a.mouseEnable, mouseEnable = _b === void 0 ? true : _b, _c = _a.touchEnable, touchEnable = _c === void 0 ? true : _c, _d = _a.threshold, threshold = _d === void 0 ? 50 : _d, _e = _a.opacity, opacity = _e === void 0 ? 1 : _e, _f = _a.zIndex, zIndex = _f === void 0 ? 998 : _f, _g = _a.closeOnBgTap, closeOnBgTap = _g === void 0 ? true : _g, _h = _a.bgTransition, bgTransition = _h === void 0 ? "opacity 0.5s ease-in-out, z-index 0.5s ease-in-out" : _h, _j = _a.className, className = _j === void 0 ? "action-sheet" : _j, _k = _a.sheetTransition, sheetTransition = _k === void 0 ? "transform 0.3s ease-in-out" : _k, _l = _a.reverse, reverse = _l === void 0 ? false : _l;
    var _m = React.useState(false), show = _m[0], setShow = _m[1];
    var _o = React.useState(false), pressed = _o[0], setPressed = _o[1];
    ...
    return (React__namespace.createElement(React.Fragment, null,
        React__namespace.createElement("div", { onClick: closeOnBgTap ? BgClick : undefined, className: className, style: __assign(__assign({ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0, 0, 0, 0.8)", backfaceVisibility: "hidden" }, bgStyle), { transition: bgTransition, opacity: show ? opacity : 0, zIndex: show ? zIndex : -1 }) }),
