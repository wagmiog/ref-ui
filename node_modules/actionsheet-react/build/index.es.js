...
var ActionSheet = React.forwardRef(function (_a, ref) {
    ...
    var _o = useState(false), pressed = _o[0], setPressed = _o[1];
    ...
    return (React.createElement(Fragment, null,
        React.createElement("div", { onClick: closeOnBgTap ? BgClick : undefined, className: className, style: __assign(__assign({ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0, 0, 0, 0.8)", backfaceVisibility: "hidden" }, bgStyle), { transition: bgTransition, opacity: show ? opacity : 0, zIndex: show ? zIndex : -1 }) }),
